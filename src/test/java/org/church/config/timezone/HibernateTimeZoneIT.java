package org.church.config.timezone;

import org.church.ChurchApp;
import org.church.repository.timezone.DateTimeWrapper;
import org.church.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM church_date_time_wrapper where id=%d", fieldName, id);
    }
