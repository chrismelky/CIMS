...
describe('Component Tests', () => {
  describe('MemberPromise Management Component', () => {
    let comp: MemberPromiseComponent;
    let fixture: ComponentFixture<MemberPromiseComponent>;
    let service: MemberPromiseService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ChurchTestModule],
        declarations: [MemberPromiseComponent],
        providers: [
          {
        ...
        .overrideTemplate(MemberPromiseComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(MemberPromiseComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.memberPromises[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
