...
import { ChurchComponent } from 'app/entities/church/church.component';
import { ChurchService } from 'app/entities/church/church.service';
import { Church } from 'app/shared/model/church.model';

describe('Component Tests', () => {
  describe('Church Management Component', () => {
    let comp: ChurchComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ChurchComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.churches[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
