...
describe('Component Tests', () => {
  describe('MemberRite Management Component', () => {
    let comp: MemberRiteComponent;
    let fixture: ComponentFixture<MemberRiteComponent>;
    let service: MemberRiteService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ChurchTestModule],
        declarations: [MemberRiteComponent],
        providers: [
          {
        ...
        .overrideTemplate(MemberRiteComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(MemberRiteComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.memberRites[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
