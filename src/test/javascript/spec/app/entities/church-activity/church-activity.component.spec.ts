...
describe('Component Tests', () => {
  describe('ChurchActivity Management Component', () => {
    let comp: ChurchActivityComponent;
    let fixture: ComponentFixture<ChurchActivityComponent>;
    let service: ChurchActivityService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ChurchTestModule],
        declarations: [ChurchActivityComponent],
        providers: [
          {
        ...
        .overrideTemplate(ChurchActivityComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ChurchActivityComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.churchActivities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
