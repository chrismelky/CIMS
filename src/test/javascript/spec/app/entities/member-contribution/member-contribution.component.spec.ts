...
describe('Component Tests', () => {
  describe('MemberContribution Management Component', () => {
    let comp: MemberContributionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MemberContributionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new MemberContribution(123)],
            headers
          })
        )
      );
      ...
      expect(comp.memberContributions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
