...
describe('Component Tests', () => {
  describe('HomeChurchCommunity Management Component', () => {
    let comp: HomeChurchCommunityComponent;
    let fixture: ComponentFixture<HomeChurchCommunityComponent>;
    let service: HomeChurchCommunityService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ChurchTestModule],
        declarations: [HomeChurchCommunityComponent],
        providers: [
          {
        ...
        .overrideTemplate(HomeChurchCommunityComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(HomeChurchCommunityComponent);
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new HomeChurchCommunity(123)],
            headers
          })
        )
      );
      ...
      expect(comp.homeChurchCommunities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
