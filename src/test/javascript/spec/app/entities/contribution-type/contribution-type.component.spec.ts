...
import { ContributionTypeComponent } from 'app/entities/contribution-type/contribution-type.component';
...
describe('Component Tests', () => {
  describe('ContributionType Management Component', () => {
    let comp: ContributionTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ContributionTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contributionTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
