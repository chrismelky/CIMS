...
describe('Component Tests', () => {
  describe('PeriodContribution Management Component', () => {
    let comp: PeriodContributionComponent;
    let fixture: ComponentFixture<PeriodContributionComponent>;
    let service: PeriodContributionService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ChurchTestModule],
        declarations: [PeriodContributionComponent],
        providers: [
          {
        ...
        .overrideTemplate(PeriodContributionComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PeriodContributionComponent);
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new PeriodContribution(123)],
            headers
          })
        )
      );
      ...
      expect(comp.periodContributions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
