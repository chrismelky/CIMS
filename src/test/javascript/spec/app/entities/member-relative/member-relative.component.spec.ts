...
describe('Component Tests', () => {
  describe('MemberRelative Management Component', () => {
    let comp: MemberRelativeComponent;
    let fixture: ComponentFixture<MemberRelativeComponent>;
    let service: MemberRelativeService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ChurchTestModule],
        declarations: [MemberRelativeComponent],
        providers: [
          {
        ...
        .overrideTemplate(MemberRelativeComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(MemberRelativeComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.memberRelatives[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
