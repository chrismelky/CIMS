...
describe('Component Tests', () => {
  describe('PeriodContributionItem Management Component', () => {
    let comp: PeriodContributionItemComponent;
    let fixture: ComponentFixture<PeriodContributionItemComponent>;
    let service: PeriodContributionItemService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ChurchTestModule],
        declarations: [PeriodContributionItemComponent],
        providers: [
          {
        ...
        .overrideTemplate(PeriodContributionItemComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PeriodContributionItemComponent);
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new PeriodContributionItem(123)],
            headers
          })
        )
      );
      ...
      expect(comp.periodContributionItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
