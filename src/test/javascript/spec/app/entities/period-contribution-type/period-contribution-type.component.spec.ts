...
describe('Component Tests', () => {
  describe('PeriodContributionType Management Component', () => {
    let comp: PeriodContributionTypeComponent;
    let fixture: ComponentFixture<PeriodContributionTypeComponent>;
    let service: PeriodContributionTypeService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ChurchTestModule],
        declarations: [PeriodContributionTypeComponent],
        providers: [
          {
        ...
        .overrideTemplate(PeriodContributionTypeComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PeriodContributionTypeComponent);
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new PeriodContributionType(123)],
            headers
          })
        )
      );
      ...
      expect(comp.periodContributionTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
