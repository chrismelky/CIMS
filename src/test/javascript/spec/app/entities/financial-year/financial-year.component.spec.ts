...
import { FinancialYearComponent } from 'app/entities/financial-year/financial-year.component';
...
describe('Component Tests', () => {
  describe('FinancialYear Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.financialYears && comp.financialYears[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
