...
import { FinancialYearDeleteDialogComponent } from 'app/entities/financial-year/financial-year-delete-dialog.component';
  ...
  describe('FinancialYear Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [FinancialYearDeleteDialogComponent]
      })
