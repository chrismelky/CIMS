...
describe('Component Tests', () => {
  describe('ChurchCommunity Management Component', () => {
    let comp: ChurchCommunityComponent;
    let fixture: ComponentFixture<ChurchCommunityComponent>;
    let service: ChurchCommunityService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ChurchTestModule],
        declarations: [ChurchCommunityComponent],
        providers: [
          {
        ...
        .overrideTemplate(ChurchCommunityComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ChurchCommunityComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.churchCommunities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
