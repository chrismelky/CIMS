...
describe('Component Tests', () => {
  describe('ChuchService Management Component', () => {
    let comp: ChuchServiceComponent;
    let fixture: ComponentFixture<ChuchServiceComponent>;
    let service: ChuchServiceService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ChurchTestModule],
        declarations: [ChuchServiceComponent],
        providers: [
          {
        ...
        .overrideTemplate(ChuchServiceComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ChuchServiceComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.chuchServices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
