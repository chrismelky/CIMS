...
import { ChurchHealthCheckComponent } from 'app/admin/health/health.component';
import { ChurchHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
  describe('ChurchHealthCheckComponent', () => {
    let comp: ChurchHealthCheckComponent;
    let fixture: ComponentFixture<ChurchHealthCheckComponent>;
    let service: ChurchHealthService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [ChurchTestModule],
        declarations: [ChurchHealthCheckComponent]
      })
        .overrideTemplate(ChurchHealthCheckComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(ChurchHealthCheckComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(ChurchHealthService);
    });
