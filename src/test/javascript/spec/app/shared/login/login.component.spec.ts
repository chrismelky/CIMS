...
import { ChurchLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
  describe('LoginComponent', () => {
    let comp: ChurchLoginModalComponent;
    let fixture: ComponentFixture<ChurchLoginModalComponent>;
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ChurchLoginModalComponent],
        providers: [
          FormBuilder,
          {
        ...
        .overrideTemplate(ChurchLoginModalComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(ChurchLoginModalComponent);
