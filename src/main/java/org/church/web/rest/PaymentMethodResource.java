...
/**
 * REST controller for managing {@link org.church.domain.PaymentMethod}.
 */
@RestController
@RequestMapping("/api")
public class PaymentMethodResource {
    ...
    public ResponseEntity<List<PaymentMethod>> getAllPaymentMethods(PaymentMethodCriteria criteria, Pageable pageable) {
