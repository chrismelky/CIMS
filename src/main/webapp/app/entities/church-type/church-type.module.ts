...
import { ChurchTypeDeleteDialogComponent, ChurchTypeDeletePopupComponent } from './church-type-delete-dialog.component';
import { churchTypePopupRoute, churchTypeRoute } from './church-type.route';
