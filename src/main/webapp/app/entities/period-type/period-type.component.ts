...
export class PeriodTypeComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.periodTypeService
      ...
      .subscribe((res: HttpResponse<IPeriodType[]>) => this.paginatePeriodTypes(res.body, res.headers));
  }
  ...
  protected paginatePeriodTypes(data: IPeriodType[], headers: HttpHeaders) {
